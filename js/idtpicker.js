...
var Christian = /** @class */ (function () {
  ...
  Christian.prototype.NatalAfter2 = function (year) {
    return (0, formatReadDate)(year, 12, 27);
  };
  return Christian;
}());
...
var China = /** @class */ (function () {
  ...
  China.prototype.Tahun = function (year) {
    return parseInt(year) + 551;
  };
  China.prototype.Shio = function (year) {
    return (parseInt(year) + 551) % 12;
  };
...
var Calendar = /** @class */ (function () {
  ...
  Calendar.prototype._includeHoliday = function (options, year, masehiDate, hijriDate, dayCount) {
    ...
    var christianNatalAfter2 = this.christian.NatalAfter2(year);
    ...
    if ((_b = options.include) === null || _b === void 0 ? void 0 : _b.showLeave) {
      ...
      if (masehiDate === christianNatalAfter2) {
        if (weekDay == 1) {
          resultDate.leaves.push({
            date: masehiDate,
            type: 0,
    ...
    if ((_c = options.include) === null || _c === void 0 ? void 0 : _c.addHolidays) {
      if (((_d = options.include) === null || _d === void 0 ? void 0 : _d.addHolidays.length) > 0) {
        for (var _i = 0, _w = (_e = options.include) === null || _e === void 0 ? void 0 : _e.addHolidays; _i < _w.length; _i++) {
          var newHoliday = _w[_i];
    ...
    if ((_j = options.include) === null || _j === void 0 ? void 0 : _j.addLeaves) {
      if (((_k = options.include) === null || _k === void 0 ? void 0 : _k.addLeaves.length) > 0) {
        for (var _x = 0, _y = (_l = options.include) === null || _l === void 0 ? void 0 : _l.addLeaves; _x < _y.length; _x++) {
          var newLeave = _y[_x];
          if (masehiDate === newLeave.date) {
            resultDate.leaves.push({
              date: masehiDate,
              name: (_m = newLeave.name) !== null && _m !== void 0 ? _m : '',
              year: year,
              age: newLeave.age,
              type: (_o = newLeave.type) !== null && _o !== void 0 ? _o : 1,
              description: (_p = newLeave.description) !== null && _p !== void 0 ? _p : '',
            });
          }
        }
      }
    }
    if ((_q = options.include) === null || _q === void 0 ? void 0 : _q.remHolidays) {
      if (((_r = options.include) === null || _r === void 0 ? void 0 : _r.remHolidays.length) > 0) {
        if (resultDate.holidays) {
          if (resultDate.holidays.length > 0) {
            for (var a = 0; a < resultDate.holidays.length; a++) {
              var aHoliday = resultDate.holidays[a];
              for (var _z = 0, _0 = (_s = options.include) === null || _s === void 0 ? void 0 : _s.remHolidays; _z < _0.length; _z++) {
                var remHoliday = _0[_z];
    ...
    if ((_t = options.include) === null || _t === void 0 ? void 0 : _t.remLeaves) {
      if (((_u = options.include) === null || _u === void 0 ? void 0 : _u.remLeaves.length) > 0) {
        if (resultDate.leaves) {
          if (resultDate.leaves.length > 0) {
            for (var a = 0; a < resultDate.leaves.length; a++) {
              var aLeave = resultDate.leaves[a];
              for (var _1 = 0, _2 = (_v = options.include) === null || _v === void 0 ? void 0 : _v.remLeaves; _1 < _2.length; _1++) {
                var remLeave = _2[_1];
    ...
    if (resultDate.holidays) {
      if (resultDate.holidays.length > 0) {
        for (var _3 = 0, _4 = resultDate.holidays; _3 < _4.length; _3++) {
          var aHoliday = _4[_3];
    ...
    if (resultDate.leaves) {
      if (resultDate.leaves.length > 0) {
        for (var _5 = 0, _6 = resultDate.leaves; _5 < _6.length; _5++) {
          var aLeave = _6[_5];
            ...
            if (Leaves){
              ...
              if (DayType === "current") {
                $.each(Leaves, function( key, value ) {
                  if (Leaves[key]) {
                    var holidaySlug = Leaves[key].name;
                    var holidayYear = Leaves[key].age ?? '';
                    var holidayName = convertHolidayName(holidaySlug) ?? holidaySlug;

                    hollist += holidayName + " " + holidayYear + ", ";
                    var holidayText = "Cuti Bersama " + holidayName + " " + holidayYear;
